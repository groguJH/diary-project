...
> 하루의 감정과 기록을 남기고, 월간 달력과 차트로 작성 흐름을 확인하는 다이어리 서비스입니다.<br/>
> 프론트엔드(Next.js)와 백엔드(SpringBoot)로 서버를 분리하고 실제 인증, 인가, DB 저장, 배포 환경까지 고려해 구현했습니다.<br/> 
> 구글 OAuth를 활용한 간편 회원가입 및 로그인 기능을 제공합니다.
